...
export const products = [
  {
    ...
    colors: [
      { name: 'Jeans Branca', color: '#f5f5f5', image: '/images/colors/white.png' },
      { name: 'Jeans Claro', color: '#d4e6f1', image: '/images/colors/light_blue.png' },
      { name: 'Jeans Escuro', color: '#5d6d7e', image: '/images/colors/dark_blue.png' },
      { name: 'Jeans Preto', color: '#212f3d', image: '/images/colors/black.png' },
    ],
    sizes: ['40', '20', '30'],
  ...
  },
  {
    ...
    images: ['/images/Banner/banner3.png', '/images/Banner/banner3.png', '/images/Banner/banner3.png'],
    colors: [
      { name: 'Preto', color: '#000000', image: '/images/colors/black.png' },
    ],
    sizes: ['P', 'M', 'G'],
  ...
  },
  {
    ...
    colors: [
      { name: 'Preto', color: '#000000', image: '/images/colors/black.png' },
      { name: 'Marrom', color: '#8b4513', image: '/images/colors/brown.png' },
    ],
    sizes: ['P', 'M', 'G'],
